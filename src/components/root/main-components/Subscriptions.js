...
class Subscriptions extends Component {
    ...
    render () {
        const routes  = {
            ...
            schange_subscritions:<ChangeSubscription confirm={this.confirmUpdatePlan}  selectedPlan={this.state.selectedPlan} setSelectedPlan={this.setSelectedPlan} returnRoute={this.selectPlan}  />,
